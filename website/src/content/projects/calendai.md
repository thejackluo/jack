...
- Launched as a Chrome extension on the Web Store, allowing users to schedule events in natural language without leaving their calendar.

## Personal Contribution

I owned the product direction, system design, and end-to-end implementation — from Chrome extension scaffolding and Google OAuth flows to the LLM prompt strategy that personalizes event drafts over time. This was a solo-built project that I maintained through multiple versions (the latest being v0.2.0 on the Chrome Web Store).
